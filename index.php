...
 Le pied du site doit contenir le nom de votre équipe.
 Une fois authentifié, on doit pouvoir se déconnecter facilement (bouton en haut à gauche de la
 page) et on doit avoir le nom de la personne connectée.
 Le site Web doit être codé en PHP, il peut y avoir du javascript si vous souhaitez faire des
graphiques
 Si vous utilisez un framework pour le CSS, attention à le maitriser SUR LE BOUT DES DOIGTS, des
questions pourront vous être posées sur le code !!*/